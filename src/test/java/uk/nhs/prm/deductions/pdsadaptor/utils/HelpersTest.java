...
import uk.nhs.prm.deductions.pdsadaptor.utlis.Helpers;
...
public class HelpersTest {
    ...
    public void testGetPrivateFromString() throws Exception {
        ...
        Helpers helperToTest = new Helpers();
        PrivateKey key = helperToTest.getPrivateKey(keyString);
        assertNotNull(key);
    }
    ...
    public void testMalformedStringException() {
        assertThrows(PEMException.class, () -> {
            Helpers helperToTest = new Helpers();
            helperToTest.getPrivateKey("test");
        });
    }
}
